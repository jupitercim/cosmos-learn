...
See the [Cosmos SDK documentation on Cosmovisor](https://docs.cosmos.network/v0.47/build/tooling/cosmovisor) to learn more about this process manager for Cosmos SDK applications.
